...
public class FrequentItemsets {
		...
		for (WordBasket query : _queries)
			for (String w : query.words) {
				if (!words.contains(w)) {
					...
					double support = (double) countOccurences(_queries, item) / maxQueries;
	...
	public static void main(String[] args) throws Exception {
		...
		Map<WordBasket, Double> result = doFrequentItemsetsAnalysis(queries, maxItemsetSize, minSupport, false);
